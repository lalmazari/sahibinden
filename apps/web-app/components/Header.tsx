  ...
  return (
    <nav className="fixed bottom-0 left-0 z-50 w-full border-t border-gray-200 bg-white shadow-md lg:hidden">
      <div className="flex justify-around items-center h-14">
        <Link href="/" className="flex flex-col items-center text-gray-600 hover:text-[#ff642d] transition">
          <Home size={20} />
          <span className="text-[10px]">Home</span>
        </Link>

        <Link href="/search" className="flex flex-col items-center text-gray-600 hover:text-[#38b49b] transition">
          <Search size={20} />
          <span className="text-[10px]">Search</span>
        </Link>

        <Link href="/addClassified" className="flex items-center justify-center w-12 h-12 rounded-full bg-[#ff642d] text-white shadow-md -mt-8 hover:bg-[#c33908] transition">
          <Plus size={24} />
        </Link>

        <Link href="/notifications" className="flex flex-col items-center text-gray-600 hover:text-[#38b49b] transition">
          <Bell size={20} />
          <span className="text-[10px]">Alerts</span>
        </Link>

        <Link href="/profile" className="flex flex-col items-center text-gray-600 hover:text-[#38b49b] transition">
          <User size={20} />
